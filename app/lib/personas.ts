...
export type Persona = {
  ...
  hireAck: string;
  msStyle: string; // first <style block seen in the live stream
...
export const PERSONAS: Record<Style, Persona> = {
  "dark-mode-premium": {
    ...
    msStyle: "Palette locked: near-black base, warm gold accent.",
    msNav: "Nav is up — minimal, confident.",
    msHero: "Hero set. Serif display doing the talking.",
    msFooter: "Footer in. Final polish pass…",
  ...
  glassmorphism: {
    ...
    msStyle: "Setting the gradient — depth first, then blur.",
    msNav: "Floating the nav on a frosted pane.",
    msHero: "Hero's shimmering in.",
    msFooter: "Footer settling — adding the last reflections.",
  ...
  brutalist: {
    ...
    msStyle: "INK + ONE LOUD COLOR. LOCKED.",
    msNav: "NAV: HEAVY RULE. DONE.",
    msHero: "HERO TYPE: MASSIVE.",
    msFooter: "FOOTER. SHIPPING.",
  ...
  playful: {
    ...
    msStyle: "Mixing the happy palette…",
    msNav: "Nav's in — round and friendly!",
    msHero: "Big cheerful hero, coming through!",
    msFooter: "Tiny footer feet attached!",
